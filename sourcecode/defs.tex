...
% enable hyper links in latex documents 
\usepackage{hyperref}
\hypersetup{hidelinks}

% % % settings -----------------------------------------------------------------------------------
\hyphenation{Government}
...
\fancypagestyle{customtitle}{
	...
	\rhead{}
	\makeatother
  \lfoot{\setlength{\unitlength}{1in}\begin{picture}(0,0)\put(3.7,0.1){\includegraphics[width=3in]{\logo}}\end{picture}}
  \cfoot{}
	\rfoot{}
}
...
% % % header and footer ---------------------------------------------------------------------------
\pagestyle{fancy}
\lhead{\setlength{\unitlength}{1in}\begin{picture}(0,0)\put(3.7,-0.3){\includegraphics[width=3in]{\logo}}\end{picture}}
\chead{}
\rhead{}
\makeatother
\newlength{\myheight}
